...
import SucessPagePopup from './SucessPagePopup';
import { useContext } from 'react';
import './style.css' 
import ScratchGiftCard from './ScratchGiftCard';

const Payment = ({totalPrice, discount, lastTotalAmount, loginState}) => {
  ...
  return (
    <>
        ...
        {orderSucess && <SucessPagePopup loginState={loginState} displayScratch={ShowScratch} showScratchCard={showScratchCard}/>}
        {showScratchCard && <ScratchGiftCard/>}
